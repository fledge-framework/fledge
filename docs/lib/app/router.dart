  ...
  static const List<NavSection> sections = [
    ...
    NavSection(
      ...
      pages: [
        ...
        NavPage(title: 'Assets', path: 'assets'),
        NavPage(title: 'Render (2D)', path: 'render'),
        NavPage(title: 'Camera (2D)', path: 'camera_2d'),
        NavPage(title: 'Particles', path: 'particles'),
        NavPage(title: 'Lighting (2D)', path: 'lighting_2d'),
        NavPage(title: 'Tween', path: 'tween'),
        NavPage(title: 'UI', path: 'ui'),
        NavPage(title: 'Debug', path: 'debug'),
        ...
        NavPage(title: 'Calendar', path: 'calendar'),
