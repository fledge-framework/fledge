...
void main() {
  group('sprite anchor', () {
    test('feet anchor (0.5, 1.0): bottom edge lands on the entity origin', () {
    ...
    test('top-left anchor (0, 0): entity origin is the sprite top-left', () {
      final rect = _destRectFor(anchor: Vector2(0, 0), size: Vector2(16, 32));
      expect(rect.left, 0);
      expect(rect.top, 0);
    ...
    test('ExtractedSprite carries the raw anchor through to the pipeline', () {
