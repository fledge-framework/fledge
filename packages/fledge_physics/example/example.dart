...
class CollisionResponseSystem extends System {
  ...
  SystemMeta get meta => SystemMeta(
    ...
    reads: {ComponentId.of<Player>(), ComponentId.of<TriggerZone>()},
...
void main() async {
  ...
  app.world.spawn()
    ...
    ..insert(
      Collider.single(RectangleShape(x: 0, y: 0, width: 200, height: 20)),
    )
  ...
  app.world.spawn()
    ...
    ..insert(Collider.single(RectangleShape(x: 0, y: 0, width: 16, height: 16)))
    ..insert(
      CollisionConfig(
